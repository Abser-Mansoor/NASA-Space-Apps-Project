...
field_id = ['T2M', 'QV2M', 'PS', 'U10M', 'V10M'] # ID of field in MERRA-2 - find ID here: https://gmao.gsfc.nasa.gov/pubs/docs/Bosilovich785.pdf 
field_name = ['2m air temperature', '2m specific humidity', 'surface pressure', '10m zonal wind', '10m meridional wind'] # Name of field to be stored with downloaded data (can use any name you like)
